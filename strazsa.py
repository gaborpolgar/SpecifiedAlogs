...
# Alprogramok , strazsasKereses, feltolt, futasIdok
...
def futasIdok(futasSzam):
    ...
    for i in range(0, futasSzam):
        ...
        eredmeny = strazsasKereses(nagySorozat, keresettElem)
...
# A következő példában az elemeKszama és a maxErtek is 1.000.000.
...
print("Egyszerű vizsgálat - Strázsás keresés")
...
fig.suptitle('Strázsás keresés vizsgálata')
